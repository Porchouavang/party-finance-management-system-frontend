...
function DashboardComponent() {
    ...
    const chartData = [
  { name: "ງານດອງ", value: 400 },
  { name: "ງານລ້ຽງ", value: 300 },
  { name: "ງານສົບ", value: 200 },
  { name: "ງານຮີດຄອງ", value: 150 }
];
        ...
        <div className="row">
          ...
          {items.map((itm) => (
            ...
            <div className={`widget widget-stats bg-${bgColor[items.indexOf(itm)]}`}>
              ...
              <div className="stats-icon" onClick={goToPartyPage} style={{cursor: 'pointer'}}>
